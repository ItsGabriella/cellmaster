...
function filtrarFuncionarios($busca, $cargo) {
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        foreach ($result as $coluna) {
            ...
            <div class="modal fade" id="modalExcluir'.$coluna["idfuncionario"].'" tabindex="-1" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0 shadow">
                  ...
                  <div class="modal-body text-center py-4">
                    ...
                    <p class="text-muted small mb-0">Você está prestes a remover o funcionário <strong>'.htmlspecialchars($coluna["nome_func"]).'</strong>. Esta ação não poderá ser desfeita.</p>
                  </div>
                  <div class="modal-footer bg-light border-0 justify-content-center">
                    <button type="button" class="btn btn-outline-secondary px-4" data-bs-dismiss="modal">Cancelar</button>
                    <a href="php/salvarFuncionario.php?IDFunc='.$coluna["idfuncionario"].'&funcao=D" class="btn btn-danger px-4 fw-semibold">Sim, Excluir</a>
                  </div>
                </div>
              </div>
            </div>
